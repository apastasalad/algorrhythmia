...
class RotationTest {
  ...
  @Test
  void rotateRightTestOne() {
    int[] testArray = {1, 2, 3, 4, 5};
    int[] testQueries = {0, 1, 2, 3, 4};
    int[] want = {4, 5, 1, 2, 3};
    int[] got = Rotation.rotateRight(testArray, 2, testQueries);

    Assertions.assertEquals(Arrays.toString(want), Arrays.toString(got));
  }

  @Test
  void RotateRightTestTwo() {
    ...
    int[] got = Rotation.rotateRight(testArray, 51, testQueries);
